...
// MQTT broker details
const char* mqtt_server = "6bd41be0555a4776852edeaf2e397702.s1.eu.hivemq.cloud";
...
void setup() {
  ...
  // Initialize sound sensor digital output pin
...
void loop() {
  ...
  // Read and write sound sensor data
  int sound_level = analogRead(33);
